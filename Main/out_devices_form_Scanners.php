...
?>
    ...
    <div class="row">
        <label class="col-sm-2 col-form-label">
            <div class="card-text" style="color:#000;">Serial Number : </div>
        </label>
        <div class="col-md-3">
            <div class="form-group">
                <input type="text" class="form-control" name="ip" id="ip" required="required"
                    placeholder="Enter Serial Number" >
                <span class="bmd-help"> Enter Scanner Serial Number </span>
            </div>
        </div>
    </div>
...
?>
    ...
    <div class="row">
        <label class="col-sm-2 col-form-label">
            <div class="card-text" style="color:#000;"> Scanner Status: </div>
        </label>
        <div class="col-md-3">
            <div class="form-group">
