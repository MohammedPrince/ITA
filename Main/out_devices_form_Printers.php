...
?>
    ...
    <div class="row" style="display:none;">
        <label class="col-sm-2 col-form-label">
            <div class="card-text" style="color:#000;">Printer Qunatity : </div>
        </label>
        <div class="col-md-3">
            <div class="form-group">
                <input type="hidden" class="form-control" name="printer_qun" required="required"
    ...
    <div class="row">
        <label class="col-sm-2 col-form-label">
            <div class="card-text" style="color:#000;">Printer IP : </div>
        </label>
        <div class="col-md-3">
            <div class="form-group">
                <input type="text" class="form-control" name="printer_ip" id="printer_ip" required="required"
                    placeholder="Enter Printer IP" >
                <span class="bmd-help"> Enter Printer IP </span>
            </div>
        </div>
    </div>
...
?>
    ...
    <div class="row">
        <label class="col-sm-2 col-form-label">
            <div class="card-text" style="color:#000;"> Printer Status: </div>
        </label>
        <div class="col-md-3">
            <div class="form-group">
