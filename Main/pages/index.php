...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2019 14:59:28 GMT -->
...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    ...
    filter-color="black" style="background-image: url('../../assets/img/log.png'); background-size: cover; background-position: top center;">
          ...
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
              ...
              <div class="card card-login card-hidden">
                ...
                <div class="card-footer justify-content-center">
                  <button type="submit" name="submit" class="btn btn-fill btn-rose waves-effect" >Login </button>
